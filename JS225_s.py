...
#         }
#         self.url_pattern = "https://stocks.finance.yahoo.co.jp/stocks/detail/?code={0}"
#         # url 队列
...
#
#         now_price = element.xpath('//*[@id="stockinf"]/div[1]/div[2]/table/tbody/tr/td[2]/text()')
#
...
#     big_list = []
#     for one_code in js225_l:
#
#         url = "https://minkabu.jp/stock/{0}/analysis?order=1&sc_id=4&tc_id=ya0j0001".format(one_code)
#         html = call_page(url)
#         try:
#             selector = etree.HTML(html)
#             now_price = selector.xpath('//*[@id="layout"]/div[2]/div[3]/div[2]/div/div[1]/div/div/div[1]/div[2]/div/div[2]/div/text()')
